...
imagePrompt: >-
  ...
  visible in the background, photorealistic and well-lit.
imagePrompt2: >-
  I need an image of a painter carefully masking windows and trim with blue
  painter's tape and plastic sheeting on the exterior of a tan stucco home in a
  suburban Colorado neighborhood, photorealistic, close-up detail shot.
imagePrompt3: >-
  I need an image of a freshly painted white and gray two-story home exterior in
  a Northern Colorado neighborhood, clean finished result with no visible
  masking or equipment, professional real estate photography style, no text.
tags:
  - exterior painting
  - professional exterior painting process
  - fort collins co
  - northern colorado
  - home exterior
...
## Day 1: Arrival, Assessment, and Surface Prep

The job doesn't start with paint. It starts with pressure washing.

On the first day, the crew arrives, does a quick walkthrough with you to confirm scope and color selections, then gets to work on surface prep. That means:

* **Pressure washing** the entire exterior to remove dirt, mildew, chalking, and loose paint
* **Scraping and sanding** any areas where old paint is peeling, cracking, or bubbling
...
## Day 2: Masking and Priming

Once surfaces are dry and prepped, Day 2 is about protecting everything that *shouldn't* get painted and building the right foundation for everything that should.

**Masking** includes:

* Covering windows, doors, and hardware with plastic sheeting and painter's tape
...
## Day 5: Detail Work, Inspection, and Cleanup

The final day isn't glamorous, but it's where quality control happens.

**Detail work** includes:

* Touching up edges, corners, and anywhere the brush didn't land perfectly
...
## Ready to See What It Looks Like on Your Home?
