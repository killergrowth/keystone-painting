...
// â”€â”€â”€ Template Engine â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/**
 * Replace {{token}} placeholders in a template string.
 * Unknown tokens â†’ empty string.
 */
...
// â”€â”€â”€ Image Helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Markdown Normalization â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Meta Generators â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function buildPaginationLinks(page, totalPages) {
  ...
  if (page > 1) {
    ...
    links.push(`<a href="${prev}" style="padding:8px 16px;border:1px solid #ddd;border-radius:4px;color:var(--link-color,var(--kg-primary,#ed1b2f));text-decoration:none;">&larr; Prev</a>`);
  }
  const range = [];
  ...
  if (page < totalPages) {
    links.push(`<a href="/blog/page/${page + 1}/" style="padding:8px 16px;border:1px solid #ddd;border-radius:4px;color:var(--link-color,var(--kg-primary,#ed1b2f));text-decoration:none;">Next &rarr;</a>`);
  }
...
// â”€â”€â”€ Template-Based Rendering â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function renderBlogIndexFromTemplate(tpl, { posts, page, totalPages, header, footer, baseHead, domain, siteName }) {
  ...
  const postCards = posts.map(post => {
    ...
    const imgHtml = imgSrc
      ? `<img class="kg-blog-card-img" src="${imgSrc}" alt="${escapeHtml(post.title)}" loading="lazy">`
      : `<div class="kg-blog-card-no-img"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></div>`;
    return `
    <div class="kg-blog-card">
      <a href="/blog/${post.slug}/">${imgHtml}</a>
      <div class="kg-blog-card-body">
        ${post.publishDate ? `<div class="kg-blog-card-date">${formatDate(post.publishDate)}</div>` : ''}
        <div class="kg-blog-card-title"><a href="/blog/${post.slug}/">${escapeHtml(post.title)}</a></div>
        <div class="kg-blog-card-excerpt">${escapeHtml(post.excerpt || '')}</div>
        <a href="/blog/${post.slug}/" class="kg-blog-card-link">Read more</a>
      </div>
    </div>`;
  }).join('');
...
// â”€â”€â”€ Inline Rendering (fallback when no templates) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  const postCards = posts.map(post => {
    ...
    <div class="kg-blog-card" style="display:flex;gap:20px;padding:24px 0;border-bottom:1px solid #eee;align-items:flex-start;">
      ...
      <div class="kg-blog-card-body" style="flex:1;min-width:0;">
        ...
        <a href="/blog/${post.slug}/" style="font-size:0.9rem;font-weight:600;color:var(--link-color,var(--kg-primary,#ed1b2f));">Read more &rarr;</a>
      </div>
    </div>`;
  }).join('');
...
function buildBlog({ srcDir, distDir, siteId, postsPerPage = 10, domain = '', siteName = '' }) {
  ...
  // Copy blog-posts/images/ â†’ dist/blog-posts/images/
...
// â”€â”€â”€ Blog Sitemap Generation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
