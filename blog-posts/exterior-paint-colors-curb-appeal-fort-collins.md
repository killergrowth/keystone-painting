...
imagePrompt: >-
  ...
  neighborhood with a warm greige or soft white exterior, crisp white trim, and
  a dark front door, photographed in bright natural sunlight with the Rocky
  Mountain foothills faintly visible in the background.
imagePrompt2: >-
  I need an image of a row of exterior paint color swatches in neutral tones —
  warm whites, soft grays, greige, and deep charcoal — laid against a wooden
  fence or painted siding sample board in an outdoor Colorado setting.
imagePrompt3: >-
  I need an image of a freshly painted Colorado home exterior in a classic navy
  and white color scheme with clean lines, a painted wood fence, and green
  landscaping, shot from the street angle as it would appear in a real estate
  listing photo.
tags:
  - exterior painting
  - curb appeal
...
[Get a free quote](/contact/) and let's find the palette that gets your home noticed — for the right reasons.
