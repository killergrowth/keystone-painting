...
imagePrompt: >-
  ...
  clipboard with a homeowner outside a beautiful two-story home in Northern
  Colorado, with blue skies and the Front Range mountains visible in the
  background. Photorealistic, warm natural lighting, no text in the image.
imagePrompt2: >-
  I need an image of a close-up of a painter's hand holding a color swatch fan
  against the freshly painted exterior of a suburban Colorado home, with soft
  afternoon light and crisp painted trim visible. Photorealistic, no text in the
  image.
imagePrompt3: >-
  I need an image of a neatly finished exterior paint job on a ranch-style home
  in a Northern Colorado neighborhood, showcasing clean edges, consistent sheen,
  and a well-maintained fence line. Photorealistic, no text in the image.
tags:
  - exterior painting
  - painting estimate
  - fort collins
...
1. **What paint product are you using, and how many coats?** Get the brand and product line.
2. **What does prep include?** Power wash, scrape, caulk, prime — confirm all of it.
3. **Are trim, soffits, and doors included?**
4. **Are you licensed and insured?** Ask for proof. In Colorado, exterior contractors should carry general liability.
5. **What's your timeline and crew size?**
